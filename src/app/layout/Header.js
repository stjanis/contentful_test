      ...
      <nav className="navbar"
        ...
        <div className={ this.state.isActive ? 'navbar-menu is-active' : 'navbar-menu'}>
          ...
          <div className="navbar-end">
            <a className="navbar-item" href="https://github.com/stjanis">
              <span className="icon">
                <i className="fab fa-lg fa-github"></i>
              </span>
            </a>
            <a className="navbar-item" href="https://twitter.com/stjanis">
              <span className="icon has-text-info" style={{ color: '#0084FF' }}>
                <i className="fab fa-lg fa-twitter"></i>
              </span>
            </a>
            <a className="navbar-item" href="https://www.linkedin.com/in/janisstipnieks/">
              Resume
